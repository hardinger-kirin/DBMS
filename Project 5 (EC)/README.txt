...
------------------------------------------------------
    ...
    ********************
        ...
        - Displays the number of rows in the table <table_name>
        - If the table does not exist, an error will be displayed
        - Otherwise, the number of rows will be displayed

        SELECT AVG(<column_name>) FROM <table_name>
        - Displays the average of the values in the column <column_name> in the table <table_name>
        - If the table does not exist, an error will be displayed
        - Otherwise, the average will be displayed

        SELECT MAX(<column_name>) FROM <table_name>
        - Displays the maximum value in the column <column_name> in the table <table_name>
        - If the table does not exist, an error will be displayed
        - Otherwise, the maximum value will be displayed
