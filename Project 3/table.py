...
November 17:
    Implemented selectAllWhere function
    Began work on selectAllJoin function

November 18:
    Implemented selectAllJoin function
...
def insert(cwd, command):
    ...
    if((table_contents[0] == '(' or table_contents[1] == '(') and table_contents[-1] == ')'):
        table_contents = table_contents[2:-1]
    table_contents = table_contents.replace("\'", '')
    table_contents = table_contents.replace("\t", '')
    table_contents = table_contents.replace(' ', '')
    table_contents = table_contents.replace(",", " | ")
